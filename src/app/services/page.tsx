...
const Services = () => {
  ...
  return (
    ...
    <div id='section-services' className='global-container z-40 '>
      ...
      <h2 id="target-pricing" data-aos="zoom-in" className=' mx-auto  pb-7 lg:pb-16 max-w-[715px] 
      text-center scroll-mt-20 md:scroll-mt-[-60px] ' >Choose Your Website Plan</h2>
      ...
      <div className='flex justify-center flex-wrap gap-10 mb-8 lg:mb-12' >
          ...
          <div className='bg-[#0c1015]  h-full '>
            ...
            <div className="flex items-center justify-center ">
              <button className=' inline-block border-none rounded-xl bg-white bg-white/15 p-2 w-[90%] text-[#746eb8] 
                  text-3xl font-bold align-top'><span className=' text-4xl '><span className='text-xl align-top'>$</span>799</span> + <span className='relative text-lg bottom-[8px]'>$</span>25/mo</button>
            </div>
        ...
        >
          ...
          <div>
            ...
            <div className="flex items-center justify-center ">
              <button className=' inline-block border-none rounded-xl bg-white bg-white/15 p-2 w-[90%] text-[#746eb8] 
                  text-3xl font-bold align-top'><span className=' text-4xl '><span className='text-xl align-top'>$</span>1399</span> + <span className='relative text-lg bottom-[8px]'>$</span>35/mo</button>
            </div>
        ...
        <div className='  overflow-hidden rounded-lg  ring-[12px] ring-white/15   inline-block ' data-aos="flip-left"  data-aos-delay='300' >
          <div className='bg-[#0c1015]  h-full '>
            ...
            <div className="flex items-center justify-center ">
              <button className=' inline-block border-none rounded-xl bg-white bg-white/15 p-2 w-[90%] text-[#746eb8] 
                  text-3xl font-bold align-top'><span className=' text-4xl '><span className='text-xl align-top'>$</span>1399</span> + <span className='relative text-lg bottom-[8px]'>$</span>599/mo</button>
            </div>
