...
const textAndPictureWindow = ({ header, paragraph, image, button, link, aditionalClassName }: TextAndPictureWindowProps) => {
    ...
    const imgClass = ` ${aditionalClassName} flex-1 relative  pt-2 md:py-3  scale-105
      object-cover object-center w-[100%] lg:w-full`


    return (
        <div
            className=' overflow-hidden rounded-2xl  border-[12px] 
               max-w-[1024px]  mb-8 lg:mb-12 border-white/15'
            data-aos="zoom-in"
        >
            <div className="flex flex-col-reverse mx-auto lg:flex-row bg-[#0c1015]">
                <div className='flex flex-col justify-center flex-1  py-6 px-3 lg:px-0 lg:pl-16'>
                    <h2>{header}</h2>
