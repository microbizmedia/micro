      ...
      <div id='section-home' className='global-container z-20' >
        ...
        <div id='consultation-window-section'
          className=' overflow-hidden rounded-[40px]  bg-gradient-to-t from-[#0c1015] to-[#746eb8] max-w-[1024px] 
              flex flex-col-reverse mx-auto lg:flex-row mb-6 lg:mb-16 pt-16 pb-4  lg:p-0' data-aos='zoom-in'
        >
        ...
        <div
          className=' overflow-hidden rounded-2xl  border-[12px]   flex flex-col-reverse
            mx-auto max-w-[1024px] lg:flex-row mb-8 lg:mb-12 lg:h-[350px]' 
          style={{ borderColor: 'rgba(255,255,255,0.15)' }} data-aos='zoom-in' >
